...
class LocalStorage {
    ...
    var service: String = """
        ...
        이 이용 약관은 웹 사이트나 모바일 어플리케이션 등 주식회사 TaekToy(이하 "회사")에서 제공하는‘UMATE’서비스에
        적용되는 것으로 회원과 회사간에 적용됩니다. 따라서 회원 가입 및 서비스 이용 전에 전체 내용을 주의해서 읽어 보십시오.
        회사는 아래의 내용에 동의하시는 회원에 한하여 정상적인 서비스를 제공할 수 있습니다. 내용에 동의하지 않으면 UMATE에서 제공하는 모든 서비스에 대한 이용이 불가능합니다.
    ...
    var privacy: String = """
    UMATE. 개인정보 처리방침
     주식회사 TaekToy(이하 "회사"라 함)는 개인정보 보호법, 정보통신망 이용촉진 및 정보보호 등에 관한 법률 등
     정보통신서비스제공자가 준수하여야 할 관련 법령상의 개인정보보호 규정을 준수하며, 관련 법령에 의거한 개인정보취급방침을 정하여 회원 권익 보호에 최선을 다하고 있습니다. 회사의 개인정보취급방침은 다음과 같은 내용을 담고 있습니다.
