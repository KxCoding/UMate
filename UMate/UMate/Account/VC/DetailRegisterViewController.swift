...
/// 회원정보를 입력하고 프로필 이미지를 저장하는 클래스입니다.
/// Author: 황신택
class DetailRegisterViewController: UIViewController {
    /// 이메일을 입력하는 텍스트필드 입니다.
    @IBOutlet weak var emailTextField: UITextField!
    
    /// 비밀번호를 입력하는 텍스트필드 입니다.
    @IBOutlet weak var passwordTextField: UITextField!
    
    /// 입력한 비밀번호를 한번더 입력하는 텍스트 필드입니다.
    @IBOutlet weak var repeatPasswordTextField: UITextField!
    
    /// 사용자 이름을 입력하는 텍스트 필드 입니다.
    @IBOutlet weak var nameTextField: UITextField!
    
    /// 사용자 닉네임을 입력하는 텍스트 필드 입니다.
    ...
    @IBAction func checkToRegisterConditions(_ sender: Any) {
        ...
        /// 사용자가 입력한 비밀번호와 동일하게 조건을 만듭니다. 조건이 false라면 경고를 출력합니다.
        ...
        /// 이름과 닉네임의 최소 문자수의 조건을 지정합니다. 조건이 false라면 경고를 출력합니다.
