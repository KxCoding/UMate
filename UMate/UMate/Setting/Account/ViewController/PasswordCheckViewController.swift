...
/// 사용자 계정 화면에서 이메일/비밀번호 변경을 클릭하면 보여주는 TableViewController 클래스
///
/// 비밀번호를 입력하면 다음 ViewController로 넘어갑니다.
/// - Author: 안상희
class PasswordCheckViewController: UIViewController {
    // MARK: Outlet
    /// 현재 비밀번호를 입력하는 textField입니다.
    @IBOutlet weak var passwordField: UITextField!
    
    /// 다음 ViewController로 이동하는 UIButton입니다.
    ...
    /// - Parameters:
    ///   - identifier: 트리거된 segue를 식별하는 문자열입니다.
    ///   - sender: segue를 시작한 객체입니다.
